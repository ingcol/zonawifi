    ...
    public function rules()
    {
        return [
            ...
            'DocumentoBeneficiario' => [
                'required','numeric','digits_between:4,15','unique:beneficiarios,DocumentoBeneficiario','min:3'
            ],
            /*
            'TelefonoBeneficiario' => [
                'required','numeric','digits_between:6,15','unique:beneficiarios,TelefonoBeneficiario','min:3'
            ],
            'EdadBeneficiario' => [
